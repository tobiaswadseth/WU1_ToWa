...
class Paginator {
	...
	*/
	...
	public function page_links($path='?',$ext=null)
	{
		...
		if ($this->_page > 1)
		    $pagination.= "<a href='".$path."$this->_instance=$prev"."$ext'>Tidigare</a>";
		else
		    $pagination.= "<span class='disabled'>Tidigare</span>";   
		...
		if ($this->_page < $counter - 1)
		    $pagination.= "<a href='".$path."$this->_instance=$next"."$ext'>Nästa</a>";
		else
		    $pagination.= "<span class='disabled'>Nästa</span>";
		    $pagination.= "</div>\n";       
		}
	return $pagination;
	}
